	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>VINCO-CAKE BAKERY</b></h3>
					<p>Jl. Tanah Merah Indah 1 No.10C</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +6287804616097</p>
					<p><i class="glyphicon glyphicon-envelope"></i> v-cake@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
				...
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>Contact Us</b></h3>
					<p>ALFO MICHAEL KAUNANG</p>
					<p>ARIQ DIMAS RABBANI</p>
					<p>ILHAM ROHUL FAJAR</p>
					<p>RACHMADITA ANGGARIZKY.F.</p>
				</div>
